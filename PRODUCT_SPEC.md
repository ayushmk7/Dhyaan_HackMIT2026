...
| **Porchlight** | **Band IMU** (impact + post-impact stillness) **+ local VLM on existing hallway CCTV**, fused | **Yes — an autonomous voice agent calls the resident; their answer routes the incident** | **Yes — band Wi-Fi/BLE + beacons, room-level; the *only* location source in B2C (no home cameras)** | **Yes**, vs a **per-resident learned baseline** | **B2C $149 + $29/mo · B2B $16/bed/mo** | — | 24 hours of detector tuning; BLE is 1–3 m; two products at once (§12) |
...
| **Cameras in resident rooms** | **We do not put cameras in resident rooms. Hallways and common areas only.** | **17 states** now have statutes governing electronic monitoring in long-term-care rooms, most requiring written consent from the resident **and the roommate**, plus signage ([KFF Health News, Apr 2025](https://kffhealthnews.org/aging/cameras-eldercare-facilities-debate-the-new-old-age-column/)). Staying out of private rooms sidesteps the hardest version entirely — and is also what Ray wants (§3.4). Note that [SafelyYou](https://www.safely-you.com/) and [Inspiren](https://www.inspiren.com/) both operate inside that patchwork, and Inspiren's AI-blurring feature is itself evidence of the resistance it produces. |
